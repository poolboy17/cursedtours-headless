...
// Dynamic import for TiptapEditor - heavy component with many extensions
const TiptapEditor = dynamic(() => import('./TiptapEditor'), {
	ssr: false,
	loading: () => (
		<div className="mx-auto w-full max-w-screen-md space-y-4 px-2.5">
			<div className="h-10 animate-pulse rounded bg-neutral-200 dark:bg-neutral-700" />
			<div className="min-h-[500px] animate-pulse rounded bg-neutral-100 dark:bg-neutral-800" />
		</div>
	),
})
